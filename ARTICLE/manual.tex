...
\section{Data}
\begin{multicols}{2}
{\noindent}There is current trend in life sciences into -omics (proteomics, genomics, metabolomics) scale of data. Unfortunately even though conducting -omics experiments is being made simpler and simpler, we still lack tools and power to process data avalanche we obtain. 
