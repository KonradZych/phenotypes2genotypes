...
<<<echo=TRUE, eval=FALSE>>=
cross <- toGenotypes(population, genotype=c("simulated","real"), orderUsing=c("none","map_genetic","map_physical"),treshold=0.01, overlapInd = 0, proportion = c(50,50), margin = 15, verbose=FALSE, debugMode=0)
@
...
<<<echo=TRUE, eval=TRUE, results=hide>>=
cross <- toGenotypes(population, genotype="simulated", orderUsing="map_genetic",treshold=0.01, overlapInd = 0, proportion = c(50,50), margin = 15, verbose=FALSE, debugMode=0)
@
